      ...
      <div className="grid grid-cols-6 gap-6 mt-16">
        <a href="#" className="relative rounded-lg overflow-hidden">
          ...
          <div className="w-full pt-16 pb-4 bg-game-gradient absolute bottom-0 left-0 right-0">
            ...
            <span className="text-zinc-300 text-sm mt-1 pl-3">4 anúncios</span>
          </div>
        </a>
        <a href="#" className="relative rounded-lg overflow-hidden">
          ...
          <div className="w-full pt-16 pb-4 bg-game-gradient absolute bottom-0 left-0 right-0">
            <strong className="font-bold text-white block pl-3">Dota</strong>
            <span className="text-zinc-300 text-sm mt-1 pl-3">4 anúncios</span>
          </div>
        </a>
        <a href="#" className="relative rounded-lg overflow-hidden">
        ...
        <a href="#" className="relative rounded-lg overflow-hidden">
          ...
          <div className="w-full pt-16 pb-4 bg-game-gradient absolute bottom-0 left-0 right-0">
            <strong className="font-bold text-white block pl-3">APEX</strong>
            <span className="text-zinc-300 text-sm mt-1 pl-3">4 anúncios</span>
          </div>
        </a>
        <a href="#" className="relative rounded-lg overflow-hidden">
